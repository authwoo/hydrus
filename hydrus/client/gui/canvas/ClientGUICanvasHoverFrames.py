...
class CanvasHoverFrameTop( CanvasHoverFrame ):
    ...
    def _ShowViewOptionsMenu( self ):
        ...
        #ClientGUIMenus.AppendMenuCheckItem( rendering_menu, 'media edge lighting', 'Set whether to enable the a back-lit edge colour bleed effect on media.', new_options.GetBoolean( 'media_effects_edge_lighting' ), CG.client_controller.new_options.FlipBoolean, 'media_effects_edge_lighting' )
