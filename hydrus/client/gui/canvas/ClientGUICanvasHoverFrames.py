...
class CanvasHoverFrameTop( CanvasHoverFrame ):
    ...
    def _ShowViewOptionsMenu( self ):
        ...
        ClientGUIMenus.AppendMenuCheckItem( rendering_menu, 'media edge lighting', 'Set whether to enable the a back-lit edge colour bleed effect on media.', new_options.GetBoolean( 'draw_media_edge_lighting' ), CG.client_controller.new_options.FlipBoolean, 'draw_media_edge_lighting' )
