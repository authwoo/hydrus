...
class GUIPagesPanel( ClientGUIOptionsPanelBase.OptionsPagePanel ):
    ...
    def UpdateOptions( self ):
        ...
        self._new_options.SetNoneableInteger( 'tab_tree_view_alignment', self._tab_tree_view_alignment.GetValue() )
        self._new_options.SetBoolean( 'tab_tree_view_hides_tabs', self._tab_tree_view_hides_tabs.isChecked() )
