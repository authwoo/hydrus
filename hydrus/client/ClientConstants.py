...
MEDIA_TRANSITION_EFFECT_FADE_IN = 0
MEDIA_TRANSITION_EFFECT_FADE_OUT = 1
MEDIA_TRANSITION_EFFECT_CROSSFADE = 2
MEDIA_TRANSITION_EFFECT_SLIDE_LEFT = 13
MEDIA_TRANSITION_EFFECT_SLIDE_RIGHT = 14
MEDIA_TRANSITION_EFFECT_SLIDE_UP = 15
MEDIA_TRANSITION_EFFECT_SLIDE_DOWN = 16
MEDIA_TRANSITION_EFFECT_SLIDE_TL = 17
MEDIA_TRANSITION_EFFECT_SLIDE_TR = 18
MEDIA_TRANSITION_EFFECT_SLIDE_BL = 19
MEDIA_TRANSITION_EFFECT_SLIDE_BR = 20
MEDIA_TRANSITION_EFFECT_ZOOM_IN = 51
MEDIA_TRANSITION_EFFECT_ZOOM_OUT = 52
MEDIA_TRANSITION_EFFECT_PLACEHOLDER = 99

MEDIA_TRANSITION_EFFECT_RANDOM = 1000
MEDIA_TRANSITION_EFFECT_RANDOM_SLIDE = 1001
MEDIA_TRANSITION_EFFECT_RAND_DIAG_SLIDE = 1002
MEDIA_TRANSITION_EFFECT_RAND_ANY_SLIDE = 1003
MEDIA_TRANSITION_EFFECT_RANDOM_ZOOM = 1004

media_transition_effect_string_lookup = {
    MEDIA_TRANSITION_EFFECT_CROSSFADE: 'crossfade',
    MEDIA_TRANSITION_EFFECT_FADE_IN: 'fade in',
    MEDIA_TRANSITION_EFFECT_FADE_OUT: 'fade out',

    MEDIA_TRANSITION_EFFECT_SLIDE_LEFT: 'slide left',
    MEDIA_TRANSITION_EFFECT_SLIDE_RIGHT: 'slide right',
    MEDIA_TRANSITION_EFFECT_SLIDE_UP: 'slide up',
    MEDIA_TRANSITION_EFFECT_SLIDE_DOWN: 'slide down',
    MEDIA_TRANSITION_EFFECT_SLIDE_TL: 'slide from top left',
    MEDIA_TRANSITION_EFFECT_SLIDE_TR: 'slide from top right',
    MEDIA_TRANSITION_EFFECT_SLIDE_BL: 'slide from bottom left',
    MEDIA_TRANSITION_EFFECT_SLIDE_BR: 'slide from bottom right',

    MEDIA_TRANSITION_EFFECT_ZOOM_IN: 'zoom in',
    MEDIA_TRANSITION_EFFECT_ZOOM_OUT: 'zoom out',

    MEDIA_TRANSITION_EFFECT_RANDOM_SLIDE: 'random slide',
    MEDIA_TRANSITION_EFFECT_RAND_DIAG_SLIDE: 'random diagonal slide',
    MEDIA_TRANSITION_EFFECT_RAND_ANY_SLIDE: 'random slide in any direction',
    MEDIA_TRANSITION_EFFECT_RANDOM_ZOOM: 'random zoom',
}
