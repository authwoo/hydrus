...
MEDIA_TRANSITION_EFFECT_FADE = 0
MEDIA_TRANSITION_EFFECT_CROSSFADE = 1
MEDIA_TRANSITION_EFFECT_SLIDE_LEFT = 2
MEDIA_TRANSITION_EFFECT_SLIDE_RIGHT = 3
MEDIA_TRANSITION_EFFECT_SLIDE_UP = 4
MEDIA_TRANSITION_EFFECT_SLIDE_DOWN = 5
MEDIA_TRANSITION_EFFECT_SLIDE_TL = 6
MEDIA_TRANSITION_EFFECT_SLIDE_TR = 7
MEDIA_TRANSITION_EFFECT_SLIDE_BL = 8
MEDIA_TRANSITION_EFFECT_SLIDE_BR = 9
MEDIA_TRANSITION_EFFECT_ZOOM_IN = 10
MEDIA_TRANSITION_EFFECT_ZOOM_OUT = 11

MEDIA_TRANSITION_EFFECT_RANDOM = 1000
MEDIA_TRANSITION_EFFECT_RANDOM_SLIDE = 1001
MEDIA_TRANSITION_EFFECT_RAND_DIAG_SLIDE = 1002
MEDIA_TRANSITION_EFFECT_RAND_CROSS_SLIDE = 1003
MEDIA_TRANSITION_EFFECT_RANDOM_ZOOM = 1004

media_transition_effect_string_lookup = {
    MEDIA_TRANSITION_EFFECT_FADE: 'fade',
    MEDIA_TRANSITION_EFFECT_CROSSFADE: 'crossfade',

    MEDIA_TRANSITION_EFFECT_SLIDE_LEFT: 'slide_left',
    MEDIA_TRANSITION_EFFECT_SLIDE_RIGHT: 'slide_right',
    MEDIA_TRANSITION_EFFECT_SLIDE_UP: 'slide_up',
    MEDIA_TRANSITION_EFFECT_SLIDE_DOWN: 'slide_down',

    MEDIA_TRANSITION_EFFECT_SLIDE_TL: 'slide_tl',
    MEDIA_TRANSITION_EFFECT_SLIDE_TR: 'slide_tr',
    MEDIA_TRANSITION_EFFECT_SLIDE_BL: 'slide_bl',
    MEDIA_TRANSITION_EFFECT_SLIDE_BR: 'slide_br',

    MEDIA_TRANSITION_EFFECT_ZOOM_IN: 'zoom_in',
    MEDIA_TRANSITION_EFFECT_ZOOM_OUT: 'zoom_out',

    MEDIA_TRANSITION_EFFECT_RANDOM_SLIDE: 'random_slide',
    MEDIA_TRANSITION_EFFECT_RAND_DIAG_SLIDE: 'rand_diag_slide',
    MEDIA_TRANSITION_EFFECT_RAND_CROSS_SLIDE: 'rand_cross_slide',
    MEDIA_TRANSITION_EFFECT_RANDOM_ZOOM: 'random_zoom',
}
